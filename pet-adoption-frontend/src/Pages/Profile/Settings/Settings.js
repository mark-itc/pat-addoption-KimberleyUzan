            ...
            <div>
                ...
                <form onSubmit={this.handleSubmit} class="row g-3 w-75 mx-auto mb-5 border border-dark p-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="phone" placeholder="+972 530893681" />
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="address" placeholder="Ben Gourion 113, GS" />
                    </div>
                    <div class="col-md-6">
                        <label for="nationality" class="form-label">Nationality</label>
                        <input type="text" class="form-control" id="nationality" placeholder="French" />
                    </div>
